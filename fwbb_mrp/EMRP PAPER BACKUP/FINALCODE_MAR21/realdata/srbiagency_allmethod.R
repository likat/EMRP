...
#-- uses SRBI+Agency
#-- does not acct for sample type in outcome model
...
write.csv(resmat_wmrp, "srbiagency_wfpbbmrp.csv")
write.csv(resmat_mmrp, "srbiagency_mmrp.csv")
write.csv(resmat_mrp2, "srbiagency_mrp2.csv")
write.csv(njmat_wmrp, "srbiagency_wfpbbmrp_nj.csv")
write.csv(njmat_mmrp, "srbiagency_mmrp_nj.csv")
write.csv(njmat_mrp2, "srbiagency_mrp2_nj.csv")
