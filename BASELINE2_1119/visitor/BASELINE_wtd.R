...
srbi_mkcts <- svywts_srbi$srbi_mkcts
...
wtsest <- matrix(nrow=sim,ncol=J)

samp <- samp[,c("J_cell", "wts", "foodindsev",
...
# write.csv(wtsest, "wfpbb_wtsest.csv")
write.csv(resmat_srbi,"BASELINE_wtd.csv")
