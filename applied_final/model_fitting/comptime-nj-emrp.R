...
t1mmrp <- Sys.time()
  ...
  comptime_wmrp <- comptime_wmrp + (t1wmrp-t0wmrp)
  comptime_mmrp <- comptime_mmrp + (t1mmrp-t0mmrp)
  print(s)
}
saveRDS(comptime_wmrp, "comptime_wmrp.rds")
saveRDS(comptime_mmrp, "comptime_mmrp.rds")
